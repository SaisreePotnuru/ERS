...
<div class="center">
<form action="http://localhost:8082/ERS1/Application.jsp"  method="post">
<div class="row">
       <div class="col-25">
...
<div class="center">
<form action="http://localhost:8082/ERS1/Reimdetailsforemp"  method="post">
<div class="row">
      <div class="col-25">
...
<div class="center">
<form action="http://localhost:8082/ERS1/Detailsofemp"  method="post">
<div class="row">
      <div class="col-25">
...
<div class="center">
<form action="http://localhost:8082/ERS1/UpdateEmployee.jsp"  method="post">
<div class="row">
      <div class="col-25">
