...
<form action="http://localhost:8082/ERS1/RegistrationServlet" method="post">
  ...
  <table class="table table-hover">
    ...
    <tbody>
      ...
      <p><b>Already have an account?</b><a href="http://localhost:8082/ERS1/Login.jsp"><b>user login here</b></a> </p>
