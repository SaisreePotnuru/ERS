...
<p><a href="http://localhost:8082/ERS1/Registration.jsp">Back to Sign up</a></p>
<form action="http://localhost:8082/ERS1/LoginServlet" method="post">
  ...
  <div class="container" style="background-color:#ffedd1">
    ...
    <span class="psw">Forgot <a href="http://localhost:8082/ERS1/ForgetPassword.html">password?</a></span>
  </div>
</form>
